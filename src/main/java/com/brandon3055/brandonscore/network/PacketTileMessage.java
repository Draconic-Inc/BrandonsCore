...
public class PacketTileMessage implements IMessage {
    ...
    public boolean isBool() { return dataType == BOOLEAN_INDEX; }

    public boolean isByte() { return dataType == BYTE_INDEX; }

    public boolean isInt() { return dataType == INT_INDEX; }

    public boolean isDouble() { return dataType == DOUBLE_INDEX; }

    public boolean isFload() { return dataType == FLOAT_INDEX; }

    public boolean isString() { return dataType == STRING_INDEX; }

    public boolean isNBT() { return dataType == TAG_INDEX; }

    public byte getIndex() { return pktIndex; }
    ...
    public static class Handler implements IMessageHandler<PacketTileMessage, IMessage> {
		...
		public IMessage onMessage(PacketTileMessage message, MessageContext ctx) {
			if (ctx.side == Side.SERVER){
                PacketSyncObject syncPacket = new PacketSyncObject<PacketTileMessage>(message, ctx) {
                    @Override
                    public void run() {
