...
// */
//public class BCConfigElement implements IConfigElement
//{
...
//                while (ccI.hasNext())
//                {
//                    BCConfigElement temp = new BCConfigElement(modid, ccI.next());
...
//            while (pI.hasNext())
//            {
//                BCConfigElement temp = new BCConfigElement(modid, pI.next());
//                if (temp.showInGui())
//                    elements.add(temp);
//            }
//
