...
public class MGuiBackground extends MGuiElementBase {
    ...
    public MGuiBackground(int xPos, int yPos, int textureX, int textureY, int xSize, int ySize, String texture) {
    ...
    public static MGuiBackground newGenericBackground(int xPos, int yPos, int xSize, int ySize) {
        return new MGuiBackground(xPos, yPos, 0, 0, xSize, ySize, ""){
            @Override
            public void renderElement(Minecraft minecraft, int mouseX, int mouseY, float partialTicks) {
