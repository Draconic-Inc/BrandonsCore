...
// * TODO Finish this. I want to re do dialogs, Improve them and switch to my custom tooltip background
// * Would also like to look into adding HSV picker support as opposed to just RGB
// */
...
//
//    public GuiColourPickerDialog(GuiElement parent) {
//        super(parent);
//        setSize(80, 80);
//        setDragBar(80);
//
//    }
//
//    public GuiColourPickerDialog(int xPos, int yPos, GuiElement parent) {
