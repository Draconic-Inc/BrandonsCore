 ...
 */
@Deprecated //This has been replaced by com.brandon3055.brandonscore.client.gui.modulargui.baseelements.GuiSlideControl
public class MGuiScrollBar extends MGuiElementBase {
    ...
    public MGuiScrollBar(int xPos, int yPos) {
        super(xPos, yPos);
    }

    public MGuiScrollBar(int xPos, int yPos, int xSize, int ySize) {
