...
//
//    protected GuiEffect(Level world, double posX, double posY)
//    {
//        this.world = world;
...
//    }
//
//    public GuiEffect(Level world, double xCoord, double yCoord, double xSpeed, double ySpeed)
//    {
...
//        float f1 = Mth.sqrt(this.motionX * this.motionX + this.motionY * this.motionY);
...
//        vertexbuffer.begin(GL11.GL_QUADS, DefaultVertexFormat.POSITION_TEX_COLOR);
//
