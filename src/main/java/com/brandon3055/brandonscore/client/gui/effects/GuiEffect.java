...
public class GuiEffect {
    ...
    public ResourceLocation activeTecture = null;

    public GuiEffect(double posX, double posY) {
    ...
    public GuiEffect(double xCoord, double yCoord, double xSpeed, double ySpeed) {
        this(xCoord, yCoord);
    ...
    public void renderParticle(float partialTicks) {
        if (activeTecture != null) {
            ResourceHelperBC.bindTexture(activeTecture);
        }
    ...
    public void setActiveTecture(ResourceLocation activeTecture) {
        this.activeTecture = activeTecture;
    }
}
