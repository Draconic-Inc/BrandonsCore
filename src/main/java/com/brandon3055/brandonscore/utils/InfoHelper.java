...
//		list.add(I18n.translateToLocal("info.de.charge.txt") + ": " + eS + " / " + eM + " RF");
	...
	public static void addEnergyAndLore(ItemStack stack, List list){
		if (!isShiftKeyDown()) list.add(I18n.translateToLocal("info.de.hold.txt")+" "+TextFormatting.AQUA + "" + TextFormatting.ITALIC + I18n.translateToLocal("info.de.shift.txt") + TextFormatting.RESET + " " + TextFormatting.GRAY + I18n.translateToLocal("info.de.forDetails.txt"));
		else {
	...
	public static boolean holdShiftForDetails(List list, boolean inverted){
		if (isShiftKeyDown() == inverted) list.add(I18n.translateToLocal("info.de.hold.txt")+" "+TextFormatting.AQUA + "" + TextFormatting.ITALIC + I18n.translateToLocal("info.de.shift.txt") + TextFormatting.RESET + " " + TextFormatting.GRAY + I18n.translateToLocal("info.de.forDetails.txt"));
	...
	public static String ITC(){return "" + TextFormatting.RESET + "" + TextFormatting.DARK_AQUA;}
	/**"Highlighted Information Text Colour" The colour used for parts that need to stand out*/
	public static String HITC(){return "" + TextFormatting.RESET + "" + TextFormatting.ITALIC + "" + TextFormatting.GOLD;}
