...
public class Teleporter
{
	...
	public static class TeleportLocation {
		...
		public void sendEntityToCoords(Entity entity){
			entity.worldObj.playSoundEffect(entity.posX, entity.posY, entity.posZ, "draconicevolution:portal", 0.1F, entity.worldObj.rand.nextFloat() * 0.1F + 0.9F);
	...
	private static Entity teleportEntity(Entity entity, TeleportLocation destination)
	{
		...
		if ((entity instanceof EntityPlayerMP))
		{
			EntityPlayerMP player = (EntityPlayerMP)entity;
			if (interDimensional) {
				player.mcServer.getConfigurationManager().preparePlayer(player, (WorldServer) destinationWorld);
			}
